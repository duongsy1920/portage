...
go test ./...                       # 272 test < 2 giây; set PORTAGE_TEST_DSN để chạy cả 32 test tích hợp
...
- 304 test; 272 unit < 2 giây, 32 test tích hợp cần `PORTAGE_TEST_DSN`; một test vàng chạy **cả vòng đời**
