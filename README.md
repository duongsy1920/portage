...
go test ./...                       # 262 test < 2 giây; set PORTAGE_TEST_DSN để chạy cả 29 test tích hợp
...
- 291 test; 262 unit < 2 giây, 29 test tích hợp cần `PORTAGE_TEST_DSN`; một test vàng chạy **cả vòng đời**
